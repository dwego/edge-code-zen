    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="flex flex-col items-center space-y-6">
        <div className="flex gap-4">
          ...
          <div className="flex cursor-pointer w-full gap-4 items-center border p-4 rounded-lg">
        ...
        <div className="flex gap-4 w-full">
          <div className="flex justify-center gap-4 w-full items-center border p-2 rounded-lg cursor-pointer" style={{backgroundColor: "rgba(255, 0, 0, 0.25)", borderColor: "#FF0000", textAlign: "center"}}>
           ...
           <div className="flex justify-center gap-4 w-full items-center border p-2 rounded-lg cursor-pointer" style={{backgroundColor: "rgba(0, 154, 46, 0.25)", borderColor: "#00910C"}}>
